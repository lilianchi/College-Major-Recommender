...
library(curl)
library(rstudioapi)
rsconnect::setAccountInfo(name='lilianchuang',
                          token='4DBF4B07E1E5D8ED371CE850F52A9F5C',
                          secret='BxYzcnNx9iByPoSvZU32bLMk/gfwZQhI5vxqhZoo')
setwd("D:/2021 Purdue MSBAIM/Course/MGMT 590 R/Project/Github/shiny_app_r-main")
...
# h2o.saveModel(fit, "D:\2021 Purdue MSBAIM\Course\MGMT 590 R\Project\Github\shiny_app_r-main", force=TRUE)
h2o.init()
#getwd()
fit = h2o.loadModel("D://2021 Purdue MSBAIM//Course//MGMT 590 R//Project//Github//shiny_app_r-main//DRF_model_R_1628545796401_12")

#h2o.confusionMatrix(fit)
#h2o.varimp(fit)
...
#h2o.get_leaderboard(object=fit2, extra_columns="ALL")
#fit2@leader
